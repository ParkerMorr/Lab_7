...
app.get('/team_stats', function(req, res) {
	...
	// var query2 = 'select count(home_score) FROM football_games WHERE home_score > visior_score;';
	// var query3 = 'select count(home_score) FROM football_games WHERE home_score < visior_score;';
	db.task('get-everything', task => {
	    return task.batch([
	        task.any(query1)
	        // task.any(query2),
